...
Public Class Form1
    ...
    Dim con As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\Asus\Documents\E-Billing.accdb")
    ...
    Public Sub Login(ByVal username As String, ByVal password As String)
        ...
        Try
            con.Open()
            Dim cmd2 As New OleDbCommand("Select * from Register where Username ='" & username & "' OR Password ='" & password & "'", con)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If ((TextBox1.Text = "") And (TextBox2.Text = "")) Then
            Label46.Text = "Please Fill all the fields !"
        Else
